...
vlog -vlog01compat -work work +incdir+D:/Workspace/Altera_Quartus_Workspace/fullAdder_4bits {D:/Workspace/Altera_Quartus_Workspace/fullAdder_4bits/tb_fullAdder_4bits.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L cycloneii_ver -L rtl_work -L work -voptargs="+acc" fullAdder_4bits
