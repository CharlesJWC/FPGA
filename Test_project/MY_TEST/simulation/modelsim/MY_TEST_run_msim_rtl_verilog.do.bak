...
vlog -vlog01compat -work work +incdir+D:/Workspace/Altera_Quartus_Workspace/MY_TEST {D:/Workspace/Altera_Quartus_Workspace/MY_TEST/MY_TEST.v}

vlog -vlog01compat -work work +incdir+D:/Workspace/Altera_Quartus_Workspace/MY_TEST {D:/Workspace/Altera_Quartus_Workspace/MY_TEST/Verilog2.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L stratixii_ver -L rtl_work -L work -voptargs="+acc" tb_MY_TEST
